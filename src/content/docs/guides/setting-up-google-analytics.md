...
2. Get access to the OIT Google Tag Manager Container
    - If you or your teammates don’t yet have access to OIT’s GTM container, email webpublishing@oit.nj.gov requesting access to the shared NJ GTM instance.
...
8. Once the GA ID and any desired custom event tracking is added, email webpublishing@oit.nj.gov to publish the tag. This step is important; without this, you will not capture analytics. 
