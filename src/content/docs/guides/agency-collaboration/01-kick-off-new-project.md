...
Note: Don’t worry too much about whether you are jumping the gun on development work ahead of a validated product roadmap. These activities will not go to waste; if the product team pivots or chooses not to engage, your work here can be reused for future projects or serve as valuable learning experience for you anyways.
...
- **Identify technical stakeholders and build relationships.** Have your stakeholders introduce you to the necessary technical owners, and schedule introductory meetings.
  - NOTE: Ensure you are going through the correct channels when working with stakeholders, technical or otherwise. If you are ever uncertain, loop in your initiative director and/or your functional director to help gain context on any pre-existing relationships or context that may exist between OOI and your stakeholders.
...
- **Get access to systems** within the agency, potentially looping in our internal ops team for help. Often this takes time, and kicking it off early can help drastically. The sooner you start, the better\!
...
- **Identify specific areas of technical unknowns.** Depending on the needs, identify key parts of a potential technical workflow and how you could build a proof-of-concept to de-risk some of those areas.
  ...
  - Example: [DOT Crash Data Problems & Solutions](https://docs.google.com/document/d/1vNv9dLWoelwubm06Zs60nZj-eQHmA2ksIYBq7rtEfvw/edit?usp=sharing) — many solutions would require writing code to extend a specific DOT program used by staff. Therefore, starting to explore
...
- Is the data available only in a certain agency cloud environment (such as Microsoft)? If so, can we deploy on the same environment to set up access, and can you prove this connection?

- Is this a situation where we could use Boomi to open a connection directly to a database and access it as an API? (Talk to Anne about what this looks like)

- Will you be connecting to sensitive data or systems and information available only via a state laptop? If so, you should loop in internal ops ASAP to ensure your hardware is requested and configured to be working effectively. (You can also look into whether our AWS workspace will satisfy your needs)
...
- Production applications should be deployed on agency infrastructure, not OOI infrastructure.

- If necessary, start working with your technical stakeholders to request the AWS resources necessary, working with the Ops team if needed to help facilitate these conversations.
  - All engineers on the project AND OOI Engineering Directors should have AWSAdministratorAccess to the relevant accounts. If the account will be billed to Innovation, the OOI Tech Ops team should also have access.
...
- What if the agency partner is waffling? What is the best use of the engineer’s time?
- Risks & mitigations workshop
- Knowing state architecture (TIP/SAR, firewall, WAF, GSN)
- How to know about relationships with stakeholders and other communications they are having?
