...
Overall, [that guide](https://learn.microsoft.com/en-us/windows/dev-environment/javascript/nodejs-on-windows#install-nvm-windows-nodejs-and-npm) is what we want to follow for setting up the node project on bare Windows
