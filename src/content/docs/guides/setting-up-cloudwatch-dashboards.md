...
You should see the Logs query screen. At the top of the console, you should see a dropdown menu labeled "selection criteria." Use this to select your log group. [More on finding your log group below.](#finding-your-log-group)
...
Use **text widgets** to add sections, context, links, or notes. I used one to add an ASCII cat to our CCM dashboard.
