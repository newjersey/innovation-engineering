...
Do not skip constructive feedback and only give positive feedback.

It is actually pretty frustrating to ask someone for feedback and be told “you’re doing great!”
Constructive feedback is a true opportunity for growth and learning. It’s how we elevate ourselves and our careers. It’s how we level up, grow ourselves, and support each other.
...
You have to truly and honestly understand that you may be wrong. Or, you might be right and the other person might be right, too. Often we come at things with different sets of information, which leads to two perfectly valid yet conflicting conclusions.
...
Ideally, feedback should be given at the time at which you notice it so that a person can understand the context while it’s fresh. After a meeting, say “I liked how you…” or “I noticed you…, maybe you could try…” Of course, this isn’t always possible, and in a [speedback](/reference/glossary) session this can be skipped.
...
Another feedback framework that gives more guidance on being specific is the [STAR Method](https://challengeme.online/en/la-methode-star-pour-donner-un-feedback/), which encourages feedback to be structured around the situation + action + result.
...
When you give praise, don't evaluate, instead describe specifically what you've seen and how it makes you feel.
...
If you were to advise someone to “be more confident” - you might mean that they should “have the confidence to say when they don’t know something”. But maybe they hear “confident” and assume you mean “say things confidently even if I don’t know they’re true.”
...
Receiving constructive feedback is hard. Even harder is receiving constructive feedback that you don’t agree with. You think the other person is wrong, you think that you don’t do that, you’re not like that, that they don’t get you.
...
There’s a common psychological distortion that convinces a brain that constructive feedback reflects on you as a person:
